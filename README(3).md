...
## 4. Định hướng phát triển tiếp theo

- Xây dựng **Order Service** (Spring Boot + PostgreSQL)
- Tích hợp **service-to-service communication**
- Bổ sung **API Gateway**
- Tích hợp CI/CD pipeline
- Triển khai lên Kubernetes (k0s / EKS)
...
- Chuẩn bị nền tảng cho CI/CD, Observability và AIOps trong các giai đoạn tiếp theo
